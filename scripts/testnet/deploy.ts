...
async function main() {
    ...
    const owner = Address.parse("UQC67azZnhLSuEt_--CbmhD0lnA-Wl8KJbQsxcQ8Ys7buDYy");
    const tonstakers = Address.parse("kQATpqPkhtMi2hIZ3OS8V_bfgo2ino6CGNqFKanE30fpokpL");
    const jetton_master = Address.parse("kQBrM7-Xi0JQj74oUIim0j-WPJ1oiAVjYiS5c9MR1NJkL_w9");
